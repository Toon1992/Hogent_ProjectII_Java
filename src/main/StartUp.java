...
//        jpa.insert(secundair);
        ...
        jpa.insert(mens);
//
        Materiaal wereldbol = new Materiaal("C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\Java\\groep06Java\\src\\images\\wereldbol.png", "Wereldbol", "Globe met verlichting, boldoorsnede 26cm", "B2.13", 1234, 4, 0, 26.56, true, globe, new HashSet<>(Arrays.asList(lager, secundair)), new HashSet<>(Arrays.asList(aardrijkskunde,maatschappij,mens,geschiedenis)));

        jpa.insert(wereldbol);

        Materiaal rekenMachine = new Materiaal("C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\Java\\groep06Java\\src\\images\\texas.jpg", "TI 84 plus", "Grafisch rekentoestel van Texas instrument", "B3.43", 2345, 10, 1, 116.99, true, texas, new HashSet<>(Arrays.asList(secundair)), new HashSet<>(Arrays.asList(wiskunde, fysica, techniek)));
