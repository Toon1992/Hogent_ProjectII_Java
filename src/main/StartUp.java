...
//        jpa.insert(secundair);
        ...
        jpa.insert(mens);
//
        Materiaal wereldbol = new Materiaal("/Users/manu/Documents/Informatica/2de jaar/2de semester/Projecten 2/Java/groep06JavaIntelliJ/src/images/wereldbol.png", "Wereldbol", "Globe met verlichting, boldoorsnede 26cm", "B2.13", 1234, 4, 0, 26.56, true, globe, new HashSet<>(Arrays.asList(lager, secundair)), new HashSet<>(Arrays.asList(aardrijkskunde,maatschappij,mens,geschiedenis)));

        jpa.insert(wereldbol);

        Materiaal rekenMachine = new Materiaal("/Users/manu/Documents/Informatica/2de jaar/2de semester/Projecten 2/Java/groep06JavaIntelliJ/src/images/texas.jpg", "TI 84 plus", "Grafisch rekentoestel van Texas instrument", "B3.43", 2345, 10, 1, 116.99, true, texas, new HashSet<>(Arrays.asList(secundair)), new HashSet<>(Arrays.asList(wiskunde, fysica, techniek)));

        jpa.insert(rekenMachine);
//
        jpa.insert(new Materiaal("/Users/manu/Documents/Informatica/2de jaar/2de semester/Projecten 2/Java/groep06JavaIntelliJ/src/images/erlenmeyer.jpg", "Erlenmeyer", "geschiedenis pack contains one flask each of 50, 125, 250, 500, and 1000mL sizes.", "B1.00", 3445, 20, 0, 43.55, false, kimax, new HashSet<Doelgroep>(Arrays.asList(secundair)), new HashSet<Leergebied>(Arrays.asList(wetenschap,biologie))));
        jpa.insert(new Materiaal("/Users/manu/Documents/Informatica/2de jaar/2de semester/Projecten 2/Java/groep06JavaIntelliJ/src/images/prisma.jpg", "Prisma Duits-Nederlands", "Pocketwoordenboek Duits-Nederlands Prisma", "B2.13", 4566, 22, 0, 9.50, true, prisma, new HashSet<Doelgroep>(Arrays.asList(lager, secundair)), new HashSet<Leergebied>(Arrays.asList(mens,maatschappij))));
        jpa.insert(new Materiaal("/Users/manu/Documents/Informatica/2de jaar/2de semester/Projecten 2/Java/groep06JavaIntelliJ/src/images/geo.jpg", "Bordgeodriehoek", "Bordgeodriehoek Wissner 80cm", "B2.13", 5431, 4, 0, 26.15, true, wissner, new HashSet<Doelgroep>(Arrays.asList(lager, secundair)), new HashSet<Leergebied>(Arrays.asList(wiskunde, fysica, techniek))));
