...
//        
        ...
        jpa.insert(new Reservatie(10,new Date(116, 1, 14), new Date(116,2,5),new Date(),ReservatieStateEnum.Gereserveerd,new Gebruiker("Donovan","donovandesmedt@gmail.com","ST"),wereldbol));
