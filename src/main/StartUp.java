...
public class StartUp extends Application {
    ...
    private void initializeDatabase() {
        ...
        jpa.insert(new Beheerder("manu.schoenmakers.v4921@student.hogent.be",true));
...
//        jpa.insert(mail);
        MailTemplate mail1=new MailNaReservatie("Bevestiging reservaties", "<p>Dag _NAAM</p>" +
