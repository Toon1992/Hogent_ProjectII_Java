...
public class StartUp extends Application {
    ...
    private void initializeDatabase() {
        ...
        jpa.insert(new Reservatie(1,2,new Date(116, 3, 23), new Date(116,4,1),ReservatieStateEnum.Gereserveerd,new Gebruiker("Toon",25),wereldbol));
        jpa.insert(new Reservatie(5,10,new Date(116, 1, 14), new Date(116,2,5),ReservatieStateEnum.Gereserveerd,new Gebruiker("De True",36),wereldbol));
        jpa.insert(new Reservatie(4,2,new Date(116, 2, 23), new Date(116,3,6),ReservatieStateEnum.Gereserveerd,new Gebruiker("Toon",58),rekenMachine));
